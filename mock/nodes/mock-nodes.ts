import { Amenity, PlaceAmenity, RoomType } from './types'

export interface MockPlacesNodes {
  // embedding: number[]
  title: string
  description: string
...
export const mockPlaces: MockPlacesNodes[] = [
  {
    // embedding: [],
    ...
    amenities: [PlaceAmenity.PARKING, PlaceAmenity.YARD],
    // hasParking: true,
    // hasYard: true,
    // yardArea: 30,
    rooms: [
      {
        ...
        // area: 25,
        amenities: [Amenity.AC, Amenity.HEATING],
        // hasAC: true,
        // hasHeating: true,
        // bedCount: 1,
        // bedType: 'double',
  ...
  },
  {
    ...
    amenities: [PlaceAmenity.PARKING, PlaceAmenity.YARD, PlaceAmenity.HEATING],
    // hasParking: true,
    // hasYard: true,
    // yardArea: 500,
    rooms: [
...
// export function generatePageContent(apt: ApartmentNode): string {
//   const parts = [
//     // Basic information
//     `${apt.title}.`,
//     apt.description,
